    ...
    properties: [
        new OA\Property(
            ...
            properties: [
                ...
                new OA\Property(property: 'path', type: 'string', format: 'url', example: 'http://localhost/api/bookables'),
                ...
                new OA\Property(
                    ...
                    items: new OA\Items(
                        properties: [
                            ...
                            new OA\Property(property: 'url', type: 'string', format: 'url', example: 'http://localhost/api/bookables?page=1', nullable: true),
                        ]
                    ),
                    minItems: 1,
                ),
